...
import { getTemplateById, updateTemplate } from "@/lib/mock-api/templates";
      ...
      try {
        ...
        if (tpl) {
          setForm({
            ...
            templateTags: tpl.templateTags || [],
            tagInput: "",
            version: tpl.version || "1.0.0",
            lastUpdateDetails: tpl.lastUpdateDetails || "",
            typeOfTemplate: tpl.typeOfTemplate || "",
            status: tpl.status || "draft",
            brandName: tpl.brandName || "",
            modelNo: tpl.modelNo || "",
            iconLogo: null, // Keep null for File type
            gatewayDetails: tpl.gatewayDetails || "",
            gatewayModelNo: tpl.gatewayModelNo || "",
            projectCode: tpl.projectCode || "",
            description: tpl.description || "",
            coverPage: null, // Keep null for File type
            graphicalCanvas: tpl.graphicalCanvas || null,
          });
          if (tpl.coverPage) setCoverPagePreview(tpl.coverPage);
        } else {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">
              Modify the details of {form.templateName}
            </p>
          </div>
        </div>
        <Button
