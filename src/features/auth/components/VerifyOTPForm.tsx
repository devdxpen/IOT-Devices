  ...
  return (
    <div className="w-full">
      ...
      <p className="text-sm text-slate-500 mb-8">
        We have sent code to <span className="font-medium text-slate-800">+91-9870654321</span>
      </p>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit, onError)} className="space-y-12">
          ...
          <Button type="submit" className="w-full bg-[#1DA1F2] hover:bg-[#1A91DA] text-white py-6 text-base">
            Enter OTP
          </Button>
        </form>
      </Form>
