 ...
 * Default: Gray (neutral gray, not warm or cool)
...
/**
 * All color palettes exported as a single object
 * for easy iteration and TypeScript inference
 */
